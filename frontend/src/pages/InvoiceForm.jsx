...
export default function InvoiceForm() {
  // Fixed: Use a static string for the initial render to ensure purity
  ...
  // We calculate these every time the component renders. 
  // This replaces the useEffect and setTotals state.
  let subtotal = 0;
  let taxTotal = 0;
  ...
  const addRow = () => {
    // Safely use Date.now() here because it's inside an event handler
    setItems([
      ...items,
      ...
      <div className="invoice-form-card">
        ...
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="form-grid">
            ...
            <div className="field">
              <label>GSTIN</label>
              <input type="text" placeholder="07ABCDE1234F1Z5" />
            </div>
            <div className="field span2">
              <label>Customer Address</label>
              <input type="text" placeholder="123, MG Road, New Delhi" />
            </div>
          </div>
          ...
          <div className="form-grid">
            ...
            <div className="field">
              <label>Notes</label>
              <textarea placeholder="Payment due within 30 days" rows={1} />
            </div>
          </div>
          ...
          {/* Totals Section - Uses the calculated variables */}
